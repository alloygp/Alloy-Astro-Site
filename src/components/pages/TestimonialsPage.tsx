...
> = [
  { kind: 'vimeo', vimeoId: VIMEO_ID, pillar: 'match', name: 'Jason Delgado', role: 'CAM Operator', teaser: 'What changes when your agency speaks the language of community association management.', length: '4:12' },
