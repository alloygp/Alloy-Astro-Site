...
export default function ResourceHubPage() {
  const featured = [
    ...
    { type: 'Micro-course', color: GREEN, title: 'Outsmarting AI Search', excerpt: '5 lessons. Free. From AI-search fundamentals to citation strategy and topic-authority mapping.', href: '/courses', read: '5 lessons' },
  ];
  const more = [
