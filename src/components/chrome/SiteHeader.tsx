                ...
                {hasFlyout && openMenu === it.id && (
                  it.megaServices && it.pillars ? (
                    <div className="nav-mega-services" role="menu">
                      {it.pillars.map((p) => (
                        <div key={p.pillar} className="nav-mega-services-col">
                          <a
                            href={p.href}
                            className="nav-mega-services-pillar"
                            style={{ borderBottomColor: p.color + '33' }}
                          >
                            <div className="nav-mega-services-pillar-icon">
                              <EngineLoop pillar={p.pillar} active={true} size={28} />
                            </div>
                            ...
                            {p.items.map((c) => (
                              <li key={c.href}>
                                <a href={c.href} role="menuitem">
                                  <span
                                    className="nav-mega-services-bullet"
                                    style={{ background: p.color }}
                                  ></span>
                                  <span className="nav-mega-services-label">{c.label}</span>
                                  {c.isNew && (
