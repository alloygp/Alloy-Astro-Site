    ...
    pillars: [
      {
        ...
        items: [
          ...
          {
            label: 'HOA Email Marketing',
            href: '/boardreach/email-marketing',
            subtitle: 'Campaigns that keep your firm top of mind with boards',
            isNew: true,
            icon: 'mail',
          },
          {
            label: 'Branding for CAM',
            href: '/boardreach/hoa-management-branding',
            subtitle: 'A brand system that signals authority before the meeting',
            isNew: true,
            icon: 'pencil',
          },
          {
            label: 'Print + Marketing Materials',
            href: '/boardreach/print-production',
            subtitle: 'Proposals, leave-behinds, and print done right',
            isNew: true,
            icon: 'archive',
          },
          {
      ...
      },
      {
        ...
        items: [
          ...
          {
            label: 'Annual Report Production',
            href: '/boardretain/annual-report-production',
            subtitle: 'Turn compliance docs into retention-stage assets',
            isNew: true,
            icon: 'bar-chart',
          },
        ],
