...
export default defineConfig({
  ...
  redirects: {
    ...
    // Canonical URL migrations — old paths → new pillar-scoped paths
    ...
    '/services/hoa-newsletter-production/': '/boardretain/newsletter-production',
    '/boardretain/newsletter-production': '/boardretain/newsletter-production',
    '/we-know-cam': '/about/we-know-cam',
    '/we-know-cam/': '/about/we-know-cam',
